...
export const demoApps: TenantApp[] = [
  ...
  { slug: 'billing', name: 'Billing', category: 'Finance', status: 'available', plan: 'Starter', route: '/finance/invoices', description: 'Create invoices, receipts, and payment reminders.' },
  { slug: 'gst-invoicing', name: 'GST Invoicing', category: 'Finance', status: 'available', plan: 'Starter', route: '/finance/invoices/new', description: 'Generate GST-ready invoices for Indian SMEs.' },
  { slug: 'accounts', name: 'Accounts', category: 'Finance', status: 'available', plan: 'Business', route: '/finance/customer-ledger', description: 'Track ledgers, cash flow, and finance reports.' },
  { slug: 'expenses', name: 'Expenses', category: 'Finance', status: 'available', plan: 'Starter', route: '/finance/expenses', description: 'Record reimbursements, vendor spends, and approvals.' },
